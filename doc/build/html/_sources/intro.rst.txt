...
* You also need to add  `.. automodule:: [module_name]` to the rst file you wantto add the script's documentation to.

* Important note: the autodocs automatically goes loads any string comment (`"""[comment]"""`) with restructured text when writing the documentation.
